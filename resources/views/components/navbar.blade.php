      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <button class="hover:bg-gray-400 hover:text-white">
            ...
            <div lass="text-sm font-medium text-gray-900">Login
          </div>
          </button>
            </x-nav-link>
          </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
         ...
         <!-- <x-nav-link href="/posts" :active="request()-> is ('Posts')">Wisata</x-nav-link> -->
 ...
 <x-nav-link href="/login" :active="request()-> is ('login')">
        ...
        <div class="mt-3 space-y-1 px-2">
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium"><x-nav-link href="/" :active="request()-> is ('/')">Home</x-nav-link></a>
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium"><x-nav-link href="/ticket" :active="request()-> is ('Tickets')">Beli Tiket</x-nav-link></a>
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium "> <x-nav-link href="/about" :active="request()-> is ('About')">About</x-nav-link></a>
        </div>
      </div>
    </div>
  </nav>
